...
BASE_PATH = "../../dash-sample-apps/apps/dash-multipage-report/"
DATA_PATH = BASE_PATH + "Data/"
# DATA_PATH = BASE_PATH.joinpath("Data").resolve()

## Read in data
supplyDemand = pd.read_csv(DATA_PATH + "supplyDemand.csv")
actualSeasonal = pd.read_csv(DATA_PATH + "actualSeasonal.csv")
industrailProd = pd.read_csv(DATA_PATH + "industrailProd.csv")
globalMarket = pd.read_csv(DATA_PATH + "globalMarket.csv")
oecdCommersial = pd.read_csv(DATA_PATH + "oecdCommersial.csv")
wtiPrices = pd.read_csv(DATA_PATH + "wtiPrices.csv")
epxEquity = pd.read_csv(DATA_PATH + "epxEquity.csv")
chinaSpr = pd.read_csv(DATA_PATH + "chinaSpr.csv")
oecdIndustry = pd.read_csv(DATA_PATH + "oecdIndustry.csv")
wtiOilprices = pd.read_csv(DATA_PATH + "wtiOilprices.csv")
productionCost = pd.read_csv(DATA_PATH + "productionCost.csv")
production2015 = pd.read_csv(DATA_PATH + "production2015.csv")
energyShare = pd.read_csv(DATA_PATH + "energyShare.csv")
adjustedSales = pd.read_csv(DATA_PATH + "adjustedSales.csv")
growthGdp = pd.read_csv(DATA_PATH + "growthGdp.csv")
                                    ...
                                    [
                                        html.Div(
                                            [
                                                html.Div(
                                                    html.Img(
                                                        src=BASE_PATH + "assets/dash-logo-new.png",
                                                        className="page-1a",
                                                    )
                                                ),
                                                html.Div(
                                                    [
                                                        ...
                                                        html.H5("BORN AI"),
                                                        html.H6("Analyzing borns in colombia."),
                                                    ],
                                                    className="page-1b",
                                                ),
                                            ],
...
#                                         html.H6("Suscipit nibh vita"),
        ...
        html.Div(
            [
                html.Div(
                    [
                        html.Div([html.H1("Current situation")], className="page-2a"),
                        html.Div(
                            [
                                            ...
                                            [
                                                html.Div(
                                                    [
                                                        ...
                                                        html.Div(
                                                            html.Img(
                                                                src=BASE_PATH + "assets/DBkxRT2.png",
                                                                className="page-6b",
                                                            )
                                                        ),
                                                    ],
                                                ...
                                                html.Div(
                                                    [
                                                        ...
                                                        html.Div(
                                                            [
                                                                html.Img(
                                                                    src=BASE_PATH + "assets/wX5mQYn.png",
